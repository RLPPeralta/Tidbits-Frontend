    ...
    <div className='Editpage d-flex justify-content-center align-items-center p-4 p-sm-3'>
        ...
        <Form className="AddForm p-4 p-sm-3" onSubmit={handleSubmit}>
            ...
            <Form.Group >
                ...
                <Form.Control required type="text" name="recipe" value={recipe} onChange={handleChange} /> 
            </Form.Group>
            <Form.Group >
                <br></br><Form.Label>From which country does this recipe originate?*</Form.Label>
                <Form.Control required type="text" name="country" rows={7} value={country} onChange={handleChange} />
            </Form.Group>
            <br></br><select required name="continent" value={continent} onChange={handleChange}>
            ...
            <Form.Group >
                ...
                <Form.Control required type="text" as="textarea" name="ingredients" rows={7} value={ingredients} onChange={handleChange} />
            </Form.Group>
            <Form.Group class="form-group" >
                <br></br><Form.Label>Instructions*</Form.Label>
                <Form.Control required type="text" as="textarea" name="instructions" class="form-control" rows={7} value={instructions} onChange={handleChange} />
            </Form.Group>
              
            <Form.Group className="mb-3" >
                <br></br><Form.Label>Upload Photo*</Form.Label>
                <Form.Control required type="text" name="image" placeholder="Type an image URL" value={image} onChange={handleChange} />
            </Form.Group>
